void Stories() {
        ...
        "Eu, enquanto programador, gostaria de testar codigo para Vertex Shader.";
        {
             ...
             com o objetivo de testa-lo.";
            {
                 ...
                 criado ou editado dentro do programa.";
                {
                    ...
                    "Eu, enquanto programador, gostaria de ser questionado se desejo salvar um arquivo modificado ao fechá-lo";

                    "Eu, enquanto programador, gostaria de poder salvar todos os arquivos abertos ao mesmo tempo.";
                }
            }
    ...
    9;
    "Eu enquanto pesquisador, gostara de obter estati­sticas sobra a execucao do meu\
    ...
    17;
    "Eu, enquanto profissional, gostaria de dispor funcionalidades extras para GLSL\
     com o objetivo de melhorar minha produtividade.";
    {
         7;
        "Eu, enquanto profissional, gostaria de carregar plugins, como bjetivo de\
         ter novas funcionalidades no programa.";

         5;
        "Eu, enquanto profissional, gostaria posicionar a iluminacao utilizando\
         o mouse.";
        {
            "Eu, enquanto profissional, gostaria que o objeto iluminador fosse\
             mostrado na visualizacao";

            "Eu, enquanto profissional, gostaria selecionar e movimentar o objeto\
             de iluminacao.";
        }

         4;
        "Eu, enquanto profissional, gostaria de ter auto-completion no editor de\
         codigo GLSL.";

         1;
        "Eu, enquanto profissional, gostaria de poder escolher entre varios\
         modelos de manipulacao de camera.";
    }
    ...
    12;
    "Eu enquanto pesquisador, gostaria de salvar o estado do programa com o\
     objetivo de retomar minhas atividades posteriormente sem perder as\
     configuracoes feitas.";

    9;
    "Eu, enquanto pesquisador, gostaria de gerar um executavel 'stand-alone' do meu\
     codigo rodando sobre um modelo, como acontece na IDE, com o objetivo de\
     leva-lo comigo e executa-lo em outros computadores mais facilmente.";
}
